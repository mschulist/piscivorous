...
species <- fread(here("ebird/data_ingest/input/birds.txt"), fill = TRUE)

# Setting up eBird directory and filtering ----------------
ebd_filters <- auk_ebd(here("ebird/data_ingest/input/ebd_US-AL-101_202103_202103_relMar-2021.txt")) %>% 
